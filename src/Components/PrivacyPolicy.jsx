function PrivacyPolicy() {
  return (
    ...
    className="sm:p-6pm ">
      <h1
      className=" sm:text-center sm:font-Poppins sm:font-bold sm:text-4xl">Privacy Policy</h1>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Campus Guide.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Campus Guide, accessible from{" "}
            <a
              href="https://www.campusguide.education"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.campusguide.education
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: query@campusguide.education</li>
      </ul>
    </div>
  );
}
