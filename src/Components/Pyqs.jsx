...
function PyqsLayout() {
  return (
    <div className="sm:w-screen  sm:mb-10 sm:h-screen sm:text-4xl ">
      ...
      <div className="sm:h-3/4 mx-auto sm:w-3/4 border border-x-2 sm:flex sm:flex-col border-slate-300 rounded-xl shadow-md">
        ...
        <div className="sm:h-full sm:flex sm:flex-row sm:justify-center sm:gap-x-36 sm:items-center">
          <div className="hover:scale-105 duration-1000 ease-in-out cursor-pointer">
            ...
            <h4 className="text-sm text-center text-slate-500 font-Poppins ">B.Tech</h4>
          </div>
          <div className="hover:scale-105 duration-1000 ease-in-out cursor-pointer">
            <img className="sm:w-24" src={folderIcon} alt="" />
            <h4 className=" text-sm text-center text-slate-500 font-Poppins">Polytechnic</h4>
          </div>
        </div>
