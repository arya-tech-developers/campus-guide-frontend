...
export default function TestimonialItem() {
  return (
    <div className="sm:min-w-[300px] sm:max-w-[384px] sm:h-[208px] sm:my-6 sm:text-base sm:rounded-2xl sm:p-8 bg-[#ffffff] font-Poppins sm:shadow-allEdges sm:tracking-wide">
