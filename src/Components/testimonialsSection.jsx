...
<section className="bg-white">
  <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
    <h2 className="text-center text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
      Here is what students write about us ?
    </h2>
        ...
        <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-0.5 text-lg font-medium text-gray-900">Deepanshu S.</p>
            </div>
          </div>
      ...
      <div className="mb-8 sm:break-inside-avoid">
        <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
          ...
          <p className="mt-4 text-gray-700">
            ...
            commodi temporibus dicta. Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt deleniti nemo neque sed reprehenderit ut vitae, possimus error expedita harum esse suscipit excepturi quas deepanshu Lorem ipsum dolor sit amet. saini sunt?
          </p>
        </blockquote>
      </div>
    </div>
