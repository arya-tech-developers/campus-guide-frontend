...
export default () => {
  ...
  return (
    <footer className="text-gray-500 bg-white w-screen px-4 py-5 max-w-screen-xl mx-auto md:px-8">
      <div className="gap-6 justify-between md:flex">
        <div className="flex-1">
          <Link
            to="/"
            className="sm:flex sm:flex-col sm:justify-evenly font-Poppins"
          >
          ...
          <form onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="max-w-sm flex items-center border rounded-md p-1">
              ...
              />
              <button className="p-2.5 rounded-md text-white bg-green-600 outline-none shadow-md focus:shadow-none sm:px-5">
                Subscribe
              </button>
            </div>
          </form>
      ...
      <div className="mt-8 py-6 border-t  items-center justify-between sm:flex">
        <div className="mt-4 sm:mt-0">
          &copy; 2024 Campus Guide All rights reserved.
        </div>
